          ...
          <div className="w-full max-w-md">
            ...
            <div className="grid grid-cols-1 gap-4">
              <button
                ...
                className="flex cursor-pointer items-center justify-center gap-2 w-full py-3 border border-gray-300 rounded-full bg-white text-sm font-semibold text-gray-700 hover:bg-gray-100"
              >
                <FaGoogle className='text-red-500' /> Login with Google
              </button>
              <button
                type="button"
                className="flex items-center cursor-pointer justify-center gap-2 w-full py-3 border border-gray-300 rounded-full bg-white text-sm font-semibold text-gray-700 hover:bg-gray-100"
              >
